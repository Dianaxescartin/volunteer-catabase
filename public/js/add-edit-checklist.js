import { addChecklistInfo, editChecklistInfo } from "./checklistActions.js";
...
async function addOrEditChecklistInfo() {
    ...
    if (currentUrl.href === urlForAdding.href) {
        await getCatsInfoForNewChecklist();
    } else if (currentUrl.href === urlForEditing.href) {
        await getChecklistInfoToEdit();
    }
}

addOrEditChecklistInfo();

async function getCatsInfoForNewChecklist() {
    try {
...
async function getChecklistInfoToEdit() {
    ...
    await editChecklistInfo(dateChecklist);
}
